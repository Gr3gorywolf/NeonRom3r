...
#pragma warning restore CS0618 // El tipo o el miembro están obsoletos
                ...
                dialogoprogreso.SetTitle("Obteniendo link de descarga de el rom  y portada...");
                dialogoprogreso.SetMessage("Por favor espere");
                dialogoprogreso.Show();
            });

            new WebClient().DownloadFile(new System.Uri(imagen),imgcache);

            var link = new superscrapper().getdownloadlink(romid).Result;
          RunOnUiThread(()=> {
           ...
           //   var imagenuri = Android.Net.Uri.Parse(imagen);
            Intent intentsend = new Intent();
              ...
              intentsend.PutExtra(Intent.ExtraStream,Android.Net.Uri.Parse(imgcache));
...
#pragma warning restore CS0618 // El tipo o el miembro están obsoletos
                dialogoprogreso.SetCanceledOnTouchOutside(false);
                dialogoprogreso.SetCancelable(false);
                dialogoprogreso.SetTitle("Obteniendo link de descarga de el rom...");
                dialogoprogreso.SetMessage("Por favor espere");
                dialogoprogreso.Show();
            });
...
#pragma warning restore CS0618 // El tipo o el miembro están obsoletos
            ...
            superscrapper escrapeador = new superscrapper();
